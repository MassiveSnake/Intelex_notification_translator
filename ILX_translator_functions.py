from PyQt5.QtWidgets import QMainWindow, QVBoxLayout, QFileDialog, QLineEdit
...
# TODO: make max size lineEdit from init (e.g., max_size -1)
...
class MyMainWindow(QMainWindow, Ui_ILX_translator_window):
    ...
    def delete_textEdits(self):
        # Clear previous LineEdits in both groupBox
    ...
    def button_clicked_import(self):
        # TODO: Introduce max number of line edits (what fits in window)
        """
    ...
    def create_dictionary(self):
        ...
        for i in range(self.layout_eng.count()):
            ...
            if text_edit_eng and text_edit_trans:  # Additional check, to see if both items exist
